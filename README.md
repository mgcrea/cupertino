...
| Desktop   | —                                          | implemented — 20 tools, AXUIElement natively; in-app, no npm package; off until switched on    |
| Simulator | —                                          | implemented — 11 tools, an iOS Simulator's screen in iOS points; in-app; off until switched on |
...
Releases are tagged per package, so a tag names what it publishes: `mail-v1.22.1`,
`reminders-v1.22.1`, `calendar-v1.22.1`, `core-v1.22.1`. The app is tagged `app-v1.22.1` and releases on its own lane —
