...
Releases are tagged per package, so a tag names what it publishes: `mail-v1.19.1`,
`reminders-v1.19.1`, `calendar-v1.19.1`, `core-v1.19.1`. The app is tagged `app-v1.19.1` and releases on its own lane —
