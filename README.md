...
Releases are tagged per package, so a tag names what it publishes: `mail-v1.23.0`,
`reminders-v1.23.0`, `calendar-v1.23.0`, `core-v1.23.0`. The app is tagged `app-v1.23.0` and releases on its own lane —
