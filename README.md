...
Releases are tagged per package, so a tag names what it publishes: `mail-v1.21.1`,
`reminders-v1.21.1`, `calendar-v1.21.1`, `core-v1.21.1`. The app is tagged `app-v1.21.1` and releases on its own lane —
